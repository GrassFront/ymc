    ...
    <nav className="w-full relative flex justify-center items-center h-[88px] bg-transparent">
      <div className="w-[1304px] h-[88px] flex flex-row justify-between items-center px-0">
        ...
        <div className="flex flex-row items-center gap-[9.85px] w-[321px] h-[64.46px]">
          ...
          {/* Name / Studio */}
          <div className="flex flex-col items-start gap-[6px] w-[198.74px] h-[51px] justify-center">
            <span className="font-sans font-normal text-[25.9619px] leading-[31px] tracking-[0.895238px] text-[#0D0D0D] whitespace-nowrap">
              YCM STUDIO
            </span>
            <span className="font-sans font-semibold text-[11.6381px] leading-[14px] tracking-[1.79048px] text-[#0D0D0D] whitespace-nowrap">
        ...
        {/* Navigation / Desktop */}
        <div className="flex flex-row items-center gap-[38px] h-[30px]">
          {NAV_ITEMS.map((item) => {
        ...
        <Link to="/contact" className="flex flex-row justify-center items-center px-[24px] py-[16px] gap-[16px] w-[215px] h-[48px] bg-[#D4A017] rounded-[5px] hover:bg-[#c29112] transition-colors cursor-pointer border-none outline-none">
          <span className="font-sans font-medium text-[16px] leading-[20px] text-[#FAF8F4] whitespace-nowrap">
            Book Chef Michael
          </span>
          <ArrowRight className="w-[20px] h-[20px] text-[#FAF8F4] flex-shrink-0" strokeWidth={1.6} />
        </Link>
